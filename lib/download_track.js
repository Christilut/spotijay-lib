...
module.exports = function(session) {
  return function(track, path, callback) {
    ...
    // set a timeout because libspotify will freeze sometimes (like when you disconnect network)
    downloadTimeout = setTimeout(function() {
      throw 'Download timeout reached. Aborting.'
    ...
    player.once('track-end', function() {
      ...
      async.waterfall([
        ...
        function(cover, callback) {
          ...
          fs.renameSync(destinyHash + '.png', destiny + '.png')
